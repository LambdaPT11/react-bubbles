...
A token is used to authenticate users, or anything you may need a unique id or number for. Typically, it used to identify and maintain a single user since the number is as unique as the user.

- [x] What steps can you take in your web apps to keep your data secure?

One can supply protected routes that locate and use a token. 

- [x] Describe how web servers work.

A web server, as a machine, holds specific software built specificaly to secure and route information. A web server as software is used to deal with incoming information, ensure security, and ensure routing.

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create -  .post, this method create a new record of state
Read -    .get, this method retrieves and returns info
Update -  .put, this method updates info already in place
Delete -  .delete, this method removes specific information in place
...
- [ ] Build a form at the bottom of `ColorList.js` to add new colors to the colors data - (worked to create working form componenets, props issue not figured out in 3 hours)
